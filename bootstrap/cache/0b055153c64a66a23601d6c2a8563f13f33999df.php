...
<div class="container mt-5 pt-3">
    ...
    <tr style="visibility: 0;" id="stripeTr">
        <td colspan="6" class="text-right" style="display: none;" id="stripeForm">
            <form action="<?php echo e(URL_ROOT); ?>payment/stripe" method="POST">
    ...
    <?php else: ?>
    <tr>
        <td colspan="6" class="text-right"><a href="<?php echo e(URL_ROOT); ?>user/login" class="btn btn-success">Login to Check out</a></td>
    </tr>
    <?php endif; ?>
    </tbody>
    </table>
    <a href='<?php echo e(URL_ROOT); ?>getitems'>Show Items</a>
</div>
...
<script>
    ...
    function payout() {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo e(URL_ROOT); ?>payout',
            data: {
              "item" : results 
            },
            success: function(result) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E_commerce\resources\views/cart.blade.php ENDPATH**/ ?>