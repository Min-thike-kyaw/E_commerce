    ...
    <div class="col-md-4">
        <ul class="list-group">
            ...
            <div class="col-md-8">    
                ...
                <form action="<?php echo e(URL_ROOT); ?>admin/product/<?php echo e($product->id); ?>/update" enctype="multipart/form-data" method="POST">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step=any class="form-control" name=price id="price" value="<?php echo e($product->price); ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="cat_id" id="cat_id" class="form-control">
                                    <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo $product->cat_id == $cat->id ? "selected" : ""?> value="<?php echo e($cat->id); ?>"><?php echo e($cat->name); ?></option>
                        ...
                        <div class="form-group">
                                ...
                                <select name="sub_cat_id" id="sub_cat_id" class="form-control">
                                    <?php $__currentLoopData = $subcats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo $product->sub_cat_id == $cat->id ? "selected" : ""?> value="<?php echo e($cat->id); ?>"><?php echo e($cat->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 p-0">
                        <div class="form-group">
                            ...
                            <textarea class=form-control name="description" id="" cols="30" rows="3"><?php echo e($product->description); ?></textarea>
                        </div>
                    </div>
...
<?php echo $__env->make("layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E_commerce\resources\views/admin/product/edit.blade.php ENDPATH**/ ?>